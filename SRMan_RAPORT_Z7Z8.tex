...
\begin{document}
	...
	\end{figure}
	\begin{figure}[H]\centering
		a) \includegraphics[width=0.30\columnwidth]{SRManCw4/SRManL4_ZADANIE2/figs/02Pozycje_U24} b)\includegraphics[width=0.30\columnwidth]{SRManCw4/SRManL4_ZADANIE2/figs/02Uchyby_U24} c)\includegraphics[width=0.30\columnwidth]{SRManCw4/SRManL4_ZADANIE2/figs/02Sygnaly_U24}\caption{
