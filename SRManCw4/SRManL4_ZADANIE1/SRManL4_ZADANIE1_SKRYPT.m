...
%       PM2R stanowi¹cych jednoczeœnie górne ograniczenie normy wektora
%       sterowañ ?.
...
%% (b)  ZADANIE 1.2
%---- • Zamodelowaæ równanie regulatora ROOS wed³ug (5) i zastosowaæ je do manipulatora (1)
%       (rys. 2). Zapewniæ mo¿liwoœæ swobodnej zmiany wartoœci zak³adanego tunelu ?. Wartoœci
%       elementów macierzy ? dobraæ doœwiadczalnie tak, aby zapewniæ minimalne przeregulo-
%       wania w przebiegu b³êdu pozycji e(t).
